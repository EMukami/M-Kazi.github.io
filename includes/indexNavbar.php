  ...
  <div class="container">
    <div class="header-left">
      <div class="logo-container">
        <img src="assets/images/Blue and Red Infinity Technology Logo.png" alt="Blue and Red Infinity Technology Logo">
        <h3>M~Kazi Gig Portal</h3>
      </div>
      <nav class="navbar">
        <ul>
          <li><a href="index.php">Home</a> </li>
          <li><a href="findJobs.php">Find Gigs</a></li>
          <li><a href="browseCompanies.php">Browse Companies & Individuals Hiring</a></li>
