        ...
        <div class="intro-banner-content">
          <div class="container glassmorphism">
            <div class="banner-headline-text-part">
              ...
              <div class="keywords">
                <p>Trending Gigs Keywords:</p>
                <span> Plumber, Carpenter, Mama Fua, House Manager, Security Guard, Personal Driver, Professional Cook, Painter, Gardener</span>
              </div>
            </div>
          </div>
        </div>
