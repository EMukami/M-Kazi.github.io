        ...
        <div class="company-details-page-content-left-side">
          <div class="company-details-page-content-left-side-about">
            <div class="headline">
              ...
              <h3>About Company & Individual Employers Details</h3>
            </div>
          ...
          <div class="company-details-page-content-left-side-jobpost">
            <div class="headline">
              ...
              <h3>Company & Individual Employers Gigs Posts</h3>
            </div>
            <?php
          ...
          <div class="review-container-area">
            <div class="headline">
              ...
              <h3>Review Company & Idividual Employers - Reviewed (<?php echo $query5->num_rows; ?>)</h3>
            </div>
